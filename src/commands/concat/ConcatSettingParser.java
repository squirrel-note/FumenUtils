...
public class ConcatSettingParser {
    private static final Options OPTIONS = getOptions();

    public static ConcatParameters parse(List<String> args) throws Exception {
        ...
        String outpath = cl.getOptionValue("o", "output/concat.txt");

        return new ConcatParameters(fumens, link, outpath);
    }
