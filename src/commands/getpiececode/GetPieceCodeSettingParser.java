...
public class GetPieceCodeSettingParser {
    private static final Options OPTIONS = getOptions();

    public static GetPieceCodeParameters parse(List<String> args) throws Exception {
        ...
        String outpath = cl.getOptionValue("o", "output/getcode.txt");

        return new GetPieceCodeParameters(fumens, outpath);
    }
