...
public class DrySettingParser {
    private static final Options OPTIONS = getOptions();

    public static DryParameters parse(List<String> args) throws Exception {
        ...
        String outpath = cl.getOptionValue("o", "output/dry.txt");

        return new DryParameters(fumens, link, outpath);
    }
