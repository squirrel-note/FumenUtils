...
public class ClearCommentSettingParser {
    private static final Options OPTIONS = getOptions();

    public static ClearCommentParameters parse(List<String> args) throws Exception {
        ...
        String outpath = cl.getOptionValue("o", "output/clearcomment.txt");

        return new ClearCommentParameters(fumens, link, outpath);
    }
