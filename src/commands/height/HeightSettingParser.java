...
public class HeightSettingParser {
    private static final Options OPTIONS = getOptions();

    public static HeightParameters parse(List<String> args) throws Exception {
        ...
        String outpath = cl.getOptionValue("o", "output/height.txt");

        return new HeightParameters(fumens, outpath);
    }
